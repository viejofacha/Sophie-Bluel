document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("photo-upload")
      .addEventListener("change", function (event) {
        ...
        const uploadButton = document.querySelector(".form-group label");
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        await loadCategories(); // Cargar categorías tras la carga completa del DOM
    ...
    document.getElementById("ajouter-photo-btn")
...
//   });
  ...
  function resetUploadForm() {
    console.log("Reseteando el formulario de subida...");
    ...
    if (photoPreview) {
        photoPreview.remove();
        console.log("Imagen previa eliminada.");
    }
    ...
    if (categorySelect) {
        ...
        console.log("Categoría reseteada.");
    }

    if (addPhotoLabel) {
        addPhotoLabel.style.display = "block";
        console.log("Botón de añadir foto visible.");
    }

    if (fileInfoText) {
        fileInfoText.style.display = "block";
        console.log("Texto de información sobre imágenes visible.");
    }
}
